...
export const TitleIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M4 20h16" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 4h11" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 9h5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 9h5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 14h5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M14 9h6" />
  </svg>
);
...
export const ClosedCaptionIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
// Fix: Add and export CheckIcon to be used across components.
